  ...
  <section className="programs" id="programs">
    ...
    <div className="feature-row reveal">
      <div className="feature-copy">
        ...
        <a href="/hifz" className="link-more" data-i18n="programs_more" aria-label={`Learn more about ${t("p1_title")}`}>{t("programs_more")}</a>
      </div>
    ...
    <div className="feature-row flip reveal">
      <div className="feature-copy">
        ...
        <a href="/tajweed" className="link-more" data-i18n="programs_more" aria-label={`Learn more about ${t("p2_title")}`}>{t("programs_more")}</a>
      </div>
      <div className="feature-media">
    ...
    <div className="feature-row reveal">
      <div className="feature-copy">
        ...
        <a href="/nazra" className="link-more" data-i18n="programs_more" aria-label={`Learn more about ${t("p3_title")}`}>{t("programs_more")}</a>
      </div>
      <div className="feature-media">
