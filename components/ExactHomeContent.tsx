...
<main id="main" onClick={handleClick}>
  ...
  <section className="stats">
    <div className="stats-grid">
      ...
      <div className="stat reveal"><span className="stat-num" data-count={15}>0</span><span className="stat-label" data-i18n="stats_years">{t("stats_years")}</span></div>
    </div>
  </section>
  {/* ================= HOW IT WORKS ================= */}
