...
import { HADITH_FEATURE_TRANSLATIONS, DONATE_FEATURE_TRANSLATIONS } from "@/lib/feature-translations";
...
export function I18nProvider({children,initialLang="en",translations}:{children:React.ReactNode;initialLang?:string;translations?:Record<string,string>}){
 ...
 const t=useCallback((key:string)=>translations?.[key]??I18N[lang]?.t[key]??HADITH_FEATURE_TRANSLATIONS[lang]?.[key]??DONATE_FEATURE_TRANSLATIONS[lang]?.[key]??I18N.en.t[key]??key,[lang,translations]);
