...
export const metadata:Metadata={
 ...
 icons:{icon:[{url:"/institute-favicon.ico",type:"image/x-icon",sizes:"48x48"},{url:"/institute-icon.png",type:"image/png",sizes:"576x576"}],shortcut:"/institute-favicon.ico",apple:"/institute-apple-icon.png"},
 verification:{google:"hvykud6Gapafst_u0AJLLujGV3l0y0hzAMk4KbcNJsw"}
};
const websiteSchema={"@context":"https://schema.org","@graph":[{"@type":"WebSite","@id":`${SITE_URL}/#website`,url:SITE_URL,name:SITE_NAME,alternateName:"مرکز المرتضٰی الاسلامی و صفیہ اسلامک انسٹیٹیوٹ",publisher:{"@id":`${SITE_URL}/#organization`}},{"@type":"EducationalOrganization","@id":`${SITE_URL}/#organization`,name:SITE_NAME,alternateName:"مرکز المرتضٰی الاسلامی و صفیہ اسلامک انسٹیٹیوٹ",url:SITE_URL,logo:`${SITE_URL}/institute-icon.png`} ]};
