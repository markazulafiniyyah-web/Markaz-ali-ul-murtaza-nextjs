...
export const metadata:Metadata={metadataBase:new URL("https://markazulmurtaza.vercel.app"),title:"Markaz ul Murtaza (may Allah be pleased with him) — Online Qur'anic Institute",description:"Learn Qur'an online with one-to-one Hifz, Nazra and Tajweed classes taught by experienced Qaris for children and adults worldwide.",keywords:["online Quran teacher","online Quran classes","Quran institute online","Hifz teacher online","online Hifz classes","Nazra Quran classes online","online Tajweed teacher","Tajweed classes online","Quran classes for kids","Quran classes for adults","Noorani Qaida online","learn Quran online"],icons:{icon:[{url:"/icon.svg",type:"image/svg+xml"},{url:"/favicon.ico",sizes:"any"}],shortcut:"/favicon.ico",apple:"/apple-icon.png"},verification:{google:"jEj58WOo1-4SvtQ5wwg3d-L3JJWoKwlYkrIDHbEidkE"}};
